import { C as getUserProjection, Ct as intersects, D as toUserCoordinate, G as applyTransform, H as scale, K as approximatelyEquals, Ot as wrapX, Q as containsExtent, S as getTransformFromProjections, St as getWidth, Tt as isEmpty, U as wrapX$1, V as rotate, W as warn, Y as clone, Z as containsCoordinate, g as fromUserCoordinate, gt as getForViewAndSize, m as equivalent, mt as getCenter, ot as equals, rt as createOrUpdateEmpty, vt as getIntersection, w as identityTransform, x as getTransform, y as get, z as degreesToStringHDMS } from "./proj-DJl9Z8yp.js";
import { C as unlistenByKey, D as getUid, E as abstract, T as VERSION, a as BaseEvent, b as EventType_default$1, c as VOID, i as Target, m as equals$1, n as BaseObject, o as FALSE, r as Observable, s as TRUE, t as assert, u as toPromise, w as ObjectEventType_default, x as listen, y as Disposable } from "./asserts-DjvUNdAm.js";
import { c as squaredSegmentDistance, d as toRadians, n as clamp, p as clear } from "./math-C_oTTWL_.js";
import { a as fromString, n as compose, o as makeInverse, r as create, s as multiply, t as apply } from "./transform-XIjOHbCN.js";
import { t as Point } from "./Point-DD09FxCN.js";
import { n as circular, t as Polygon } from "./Polygon-EanL5xvI.js";
import { a as LineString } from "./MultiPolygon-BV9nrbxB.js";
import { a as CollectionEventType_default, i as Collection, r as Feature, t as VectorSource } from "./Vector-BfUj3KAt.js";
import { S as ImageState_default, _ as DEVICE_PIXEL_RATIO, a as createMockDiv, b as WEBKIT, c as outerHeight, d as removeChildren, f as replaceChildren, i as createCanvasContext2D, l as outerWidth, m as ImageWrapper, p as replaceNode, s as isCanvas, t as hasArea, u as releaseCanvas, v as MAC, x as WORKER_OFFSCREEN_CANVAS, y as PASSIVE_EVENT_LISTENERS } from "./size-CMYNby8r.js";
import { a as TileState_default, i as Tile, r as ImageTile, t as TileRange } from "./TileRange-CnQgjWdW.js";
import { i as linear, n as easeOut } from "./easing-Cg3bWlZE.js";
import { D as CLASS_HIDDEN, E as CLASS_CONTROL, M as shared, O as CLASS_SELECTABLE, T as CLASS_COLLAPSED, d as checkedFonts, k as CLASS_UNSELECTABLE, l as Stroke, n as Text, r as Style, u as Fill } from "./Icon-C1GcMYla.js";
import { i as CanvasImmediateRenderer, n as BaseVectorLayer, r as getSquaredTolerance, t as VectorLayer } from "./Vector-DM-v7k_p.js";
import { a as disable, c as RenderEvent, d as EventType_default$2, i as View, n as inView, r as BaseLayer, t as Layer, u as ViewHint_default } from "./Layer-DQsDMtY5.js";
//#region node_modules/ol/Geolocation.js
/**
...
* @enum string
*/
var GeolocationErrorType = { ERROR: "error" };
/**
* @classdesc
* Events emitted on [GeolocationPositionError](https://developer.mozilla.org/en-US/docs/Web/API/GeolocationPositionError).
*/
var GeolocationError = class extends BaseEvent {
	/**
...
* @api
*/
var Geolocation = class extends BaseObject {
	/**
	...
	*/
	constructor(options) {
		...
		*/
		...
		this.addChangeListener(Property$2.PROJECTION, this.handleProjectionChanged_);
		this.addChangeListener(Property$2.TRACKING, this.handleTrackingChanged_);
		if (options.projection !== void 0) this.setProjection(options.projection);
		if (options.trackingOptions !== void 0) this.setTrackingOptions(options.trackingOptions);
	...
	*/
	handleProjectionChanged_() {
		...
		if (projection) {
			...
			if (this.position_) this.set(Property$2.POSITION, this.transform_(this.position_));
		}
	}
	/**
	* @private
	*/
	handleTrackingChanged_() {
		if ("geolocation" in navigator) {
			...
			if (tracking && this.watchId_ === void 0) this.watchId_ = navigator.geolocation.watchPosition(this.positionChange_.bind(this), this.positionError_.bind(this), this.getTrackingOptions());
	...
	*/
	positionChange_(position) {
		...
		if (!this.position_) this.position_ = [coords.longitude, coords.latitude];
		else {
			this.position_[0] = coords.longitude;
			this.position_[1] = coords.latitude;
		}
		const projectedPosition = this.transform_(this.position_);
		this.set(Property$2.POSITION, projectedPosition.slice());
	...
	*/
	setProjection(projection) {
		this.set(Property$2.PROJECTION, get(projection));
	}
	/**
...
//#endregion
//#region node_modules/ol/ImageCanvas.js
/**
...
*/
var ImageCanvas = class extends ImageWrapper {
	/**
	...
	*/
	handleLoad_(err) {
		...
		} else this.state = ImageState_default.LOADED;
		this.changed();
	}
	/**
...
//#endregion
//#region node_modules/ol/geom/flat/geodesic.js
/**
...
//#endregion
//#region node_modules/ol/render.js
/**
...
function getVectorContext(event) {
	if (!(event.context instanceof CanvasRenderingContext2D)) throw new Error("Only works for render events from Canvas 2D layers");
	...
	if (userProjection) userTransform = getTransformFromProjections(userProjection, frameState.viewState.projection);
...
//#endregion
//#region node_modules/ol/layer/Graticule.js
/**
...
var Graticule = class extends VectorLayer {
		...
		*/
		...
		if (options.showLabels) {
			...
			*/
			...
			this.addEventListener(EventType_default$2.POSTRENDER, this.drawLabels_.bind(this));
		}
		/**
		* @type {Array<number>}
		* @private
	...
	*/
	strategyFunction(extent, resolution) {
		...
		if (this.projection_ && this.getSource().getWrapX()) wrapX(realWorldExtent, this.projection_);
		...
		else this.getSource().removeLoadedExtent(this.loadedExtent_);
	...
	*/
	createGraticule_(extent, center, resolution, squaredTolerance) {
		...
		const projectionExtent = this.projection_.getExtent();
		const worldWidth = getWidth(projectionExtent);
		if (this.getSource().getWrapX() && this.projection_.canWrapX() && !containsExtent(projectionExtent, extent)) if (getWidth(extent) >= worldWidth) {
	...
	*/
	updateProjectionInfo_(projection) {
		...
		const worldExtentP = applyTransform([
			...
			this.maxLon_,
			this.maxLat_
		], this.fromLonLatTransform_, void 0, 8);
...
*/
var canvasPool = [];
var VectorRenderTile = class extends Tile {
	/**
	...
	*/
	getContext() {
		if (!this.context_) this.context_ = createCanvasContext2D(1, 1, canvasPool);
...
//#endregion
//#region node_modules/ol/VectorTile.js
/**
...
*/
var VectorTile = class extends Tile {
	/**
	* @param {import("./tilecoord.js").TileCoord} tileCoord Tile coordinate.
	* @param {import("./TileState.js").default} state State.
...
//#endregion
export { Collection, Disposable, Feature, Geolocation, Graticule, ImageWrapper as Image, ImageWrapper, ImageCanvas, ImageTile, Kinetic, Map, MapBrowserEvent, MapBrowserEventHandler, MapEvent, BaseObject as Object, Observable, Overlay, Tile, TileQueue, TileRange, VERSION, VectorRenderTile, VectorTile, View, getUid };

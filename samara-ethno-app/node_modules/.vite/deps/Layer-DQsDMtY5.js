import { B as equals, C as getUserProjection, Ct as intersects, D as toUserCoordinate, I as METERS_PER_UNIT, L as add, O as toUserExtent, St as getWidth, Tt as isEmpty, V as rotate, _ as fromUserExtent, _t as getHeight, bt as getTopLeft, ft as getBottomLeft, g as fromUserCoordinate, gt as getForViewAndSize, mt as getCenter, p as disableCoordinateWarning, pt as getBottomRight, u as createProjection, xt as getTopRight } from "./proj-DJl9Z8yp.js";
import { C as unlistenByKey, E as abstract, _ as linearFindNearest, a as BaseEvent, b as EventType_default$1, c as VOID, m as equals$1, n as BaseObject, r as Observable, t as assert, x as listen } from "./asserts-DjvUNdAm.js";
import { a as modulo, d as toRadians, n as clamp } from "./math-C_oTTWL_.js";
import { i as equivalent, l as toString, n as compose, o as makeInverse, r as create, t as apply } from "./transform-XIjOHbCN.js";
import { r as fromExtent } from "./Polygon-EanL5xvI.js";
import { S as ImageState_default, a as createMockDiv, i as createCanvasContext2D, o as getSharedCanvasContext2D, s as isCanvas, x as WORKER_OFFSCREEN_CANVAS } from "./size-CMYNby8r.js";
import { n as easeOut, r as inAndOut } from "./easing-Cg3bWlZE.js";
import { n as asArray } from "./color-B5NC7YrZ.js";
...
var LayerRenderer = class extends Observable {
	...
	*/
	loadImage(image) {
		...
		if (imageState != ImageState_default.LOADED && imageState != ImageState_default.ERROR) image.addEventListener(EventType_default$1.CHANGE, this.boundHandleImageChange_);
...
var CanvasLayerRenderer = class extends LayerRenderer {
	...
	*/
	useContainer(target, transform, backgroundColor) {
		...
		if (target && target.className === layerClassName && (!backgroundColor || target && target.style.backgroundColor && equals$1(asArray(target.style.backgroundColor), asArray(backgroundColor)))) {
...
//#endregion
export { disable as a, RenderEvent as c, EventType_default as d, View as i, ZIndexContext as l, inView as n, CanvasLayerRenderer as o, BaseLayer as r, canvasPool as s, Layer as t, ViewHint_default as u };

//# sourceMappingURL=Layer-DQsDMtY5.js.map